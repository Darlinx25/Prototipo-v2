...
// Los imports de com.ioteste.app.* no son necesarios si estamos en el mismo paquete
...
/**
 * Esta es la COPIA de App.java, modificada para testing.
 * Se usará como clase base para AppIntegrationTest.
 * (Contiene los 4 cambios a 'protected')
 */
public class AppTest {
    ...
    // CAMBIO 1: private -> protected
    protected DataSite siteConfig;

    // CAMBIO 2: private -> protected
    protected List<DataSwitch> knownSwitchStatus = new ArrayList<>();
    ...
    // CAMBIO 4: private -> protected
    protected List<DataSwitch> snapshotSwitchStatus() {
        synchronized (switchLock) {
